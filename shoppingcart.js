product.addItem( { name: 'Jaffas', brand: 'Allens', price: 5.5 } )
   product.addItem( { name: 'Kit Kat', brand: 'Nestle', price: 8.5 } )
   product.addItem( { name: 'Milkybar', brand: 'Nestle', price: 4 } )
   product.addItem( { name: 'Smarties', brand: 'Nestle', price: 3.5 } )
   product.addItem( { name: 'Banana', price: 5.5 } )
   Error:
     > Expected: { brand: <string>, name: <string>, price: <number> }
     > Received:  { name: 'Banana', price: 5.5 }
   product.getItems()
    [ { id: 0, brand: 'Allens', name: 'Jaffas', price: 5.5 },
     { id: 1, brand: 'Nestle', name: 'Kit Kat', price: 8.5 },
     { id: 2, brand: 'Nestle', name: 'Milkybar', price: 4 },
     { id: 3, brand: 'Nestle', name: 'Smarties', price: 3.5 } ]
   product.removeItem(2)
    { id: 2, brand: 'Nestle', name: 'Milkybar', price: 4 }
   product.getItems()
    [ { id: '0', brand: 'Allens', name: 'Jaffas', price: 5.5 },
     { id: '1', brand: 'Nestle', name: 'Kit Kat', price: 8.5 },
     { id: '2', brand: 'Nestle', name: 'Smarties', price: 3.5 } ]
